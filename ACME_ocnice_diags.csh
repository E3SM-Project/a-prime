...
echo "casename = $casename" >> $configFile
echo "native_res = $native_res" >> $configFile
echo "short_term_archive = $short_term_archive" >> $configFile
echo "casename_model_tocompare = $casename_model_tocompare" >> $configFile
echo "" >> $configFile
echo "[paths]" >> $configFile
echo "archive_dir = $archive_dir" >> $configFile
echo "archive_dir_ocn = $archive_dir_ocn" >> $configFile
echo "scratch_dir = $scratch_dir" >> $configFile
...
echo "climo_yr1 = $climo_yr1" >> $configFile
echo "climo_yr2 = $climo_yr2" >> $configFile
