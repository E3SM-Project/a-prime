...
#          At a minimum, the following variables need to be set (see below for a 
#          detailed description): output_base_dir, test_casename, and test_archive_dir
#       3. execute: ./run_aprime_$user.bash 
#
# List of ACME output files that are needed for A-Prime to work:
#       - atmosphere files: *.cam.h0.*.nc
#       - mpas-o files: mpaso.hist.am.timeSeriesStatsMonthly.*.nc
#                       mpaso.rst.0002-01-01_00000.nc (or any other restart file)
#                       streams.ocean
#       - mpas-cice files: mpascice.hist.am.timeSeriesStatsMonthly.*.nc
#                          streams.cice
#
...
#	short_term_archive:   Adds /(modelcomponent)/hist after the casename. If the data sits in a different
#                             structure, add it after the casename in test_casename
...
#  Root directory pointing to model data. If test_short_term_archive=0, $test_casename/run will
#  be appended to test_archive_dir. If test_short_term_archive=1, $test_casename/modelcomponent/hist
...
#  MPAS mesh name (e.g. oEC60to30v1 (beta0 runs and older), oEC60to30v3 (beta1 runs and newer), oRRS18to6v3)
