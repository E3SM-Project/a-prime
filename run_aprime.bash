...
#                   files, no matter what begin_yr_ts, end_yr_ts are).
...
#	short_term_archive: If equal to 1, the script adds /(modelcomponent)/hist after
#                           the casename to archive_dir. If the data sits in a different
