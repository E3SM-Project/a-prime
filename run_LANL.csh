...
#
#Basic usage:
#       1. copy this template to something like run_LANL_$user.csh
#       #       2. open run_LANL_$user.csh and set user defined, case-specific variables
#       #       3. execute: csh run_LANL_$user.csh
...
set projdir =                                  /usr/projects/climate
...
setenv test_end_yr_climo               3
setenv test_begin_yr_ts                1
setenv test_end_yr_ts                  4
...
setenv obs_ocndir                 $projdir/SHARED_CLIMATE/observations
setenv obs_seaicedir              $projdir/SHARED_CLIMATE/observations/SeaIce
...
setenv www_dir $projdir/$USER/acme/www
